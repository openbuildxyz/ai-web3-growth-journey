module.exports = [
"[project]/typescript/packages/core/dist/esm/chunk-VE37GDG2.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/typescript/packages/core/dist/esm/chunk-3IUBYRYG.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/typescript/packages/core/dist/esm/chunk-BJTO5JO5.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/typescript/packages/core/dist/esm/chunk-RCHDDVGC.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$VE37GDG2$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/typescript/packages/core/dist/esm/chunk-VE37GDG2.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/typescript/packages/core/dist/esm/chunk-3IUBYRYG.mjs [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$BJTO5JO5$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/typescript/packages/core/dist/esm/chunk-BJTO5JO5.mjs [middleware] (ecmascript)");
;
;
;
...
var x402HTTPResourceServer = class {
   ...
   */ validateRouteConfiguration() {
        ...
        for (const [pattern, config] of normalizedRoutes){
            ...
            for (const option of paymentOptions){
                ...
                const supportedKind = this.ResourceServer.getSupportedKind(__TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$VE37GDG2$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["x402Version"], option.network, option.scheme);
                if (!supportedKind) {
                    errors.push({
                        routePattern: pattern,
                        scheme: option.scheme,
   ...
   */ generatePaywallHTML(paymentRequired, paywallConfig, customHtml) {
        ...
        try {
            const paywall = (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$BJTO5JO5$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["__require"])("@x402/paywall");
...
function encodePaymentSignatureHeader(paymentPayload) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["safeBase64Encode"])(JSON.stringify(paymentPayload));
}
function decodePaymentSignatureHeader(paymentSignatureHeader) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["Base64EncodedRegex"].test(paymentSignatureHeader)) {
        throw new Error("Invalid payment signature header");
    }
    return JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["safeBase64Decode"])(paymentSignatureHeader));
}
function encodePaymentRequiredHeader(paymentRequired) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["safeBase64Encode"])(JSON.stringify(paymentRequired));
}
function decodePaymentRequiredHeader(paymentRequiredHeader) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["Base64EncodedRegex"].test(paymentRequiredHeader)) {
        throw new Error("Invalid payment required header");
    }
    return JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["safeBase64Decode"])(paymentRequiredHeader));
}
function encodePaymentResponseHeader(paymentResponse) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["safeBase64Encode"])(JSON.stringify(paymentResponse));
}
function decodePaymentResponseHeader(paymentResponseHeader) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["Base64EncodedRegex"].test(paymentResponseHeader)) {
        throw new Error("Invalid payment response header");
    }
    return JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["safeBase64Decode"])(paymentResponseHeader));
}
;
 //# sourceMappingURL=chunk-RCHDDVGC.mjs.map
}),
"[project]/typescript/packages/core/dist/esm/server/index.mjs [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var x402ResourceServer = class {
   ...
   */ constructor(facilitatorClients){
        ...
        if (!facilitatorClients) {
            this.facilitatorClients = [
                new __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$RCHDDVGC$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["HTTPFacilitatorClient"]()
            ];
   ...
   */ hasRegisteredScheme(network, scheme) {
        return !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["findByNetworkAndScheme"])(this.registeredServerSchemes, scheme, network);
    }
    /**
   ...
   */ getSupportedKind(x402Version2, network, scheme) {
        ...
        const supportedResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["findByNetworkAndScheme"])(versionMap, scheme, network);
   ...
   */ async buildPaymentRequirements(resourceConfig) {
        ...
        const SchemeNetworkServer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["findByNetworkAndScheme"])(this.registeredServerSchemes, scheme, resourceConfig.network);
        if (!SchemeNetworkServer) {
            console.warn(`No server implementation registered for scheme: ${scheme}, network: ${resourceConfig.network}`);
            return requirements;
        }
        const supportedKind = this.getSupportedKind(__TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$VE37GDG2$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["x402Version"], resourceConfig.network, SchemeNetworkServer.scheme);
        if (!supportedKind) {
        ...
        const facilitatorExtensions = this.getFacilitatorExtensions(__TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$VE37GDG2$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["x402Version"], resourceConfig.network, SchemeNetworkServer.scheme);
        ...
        const requirement = await SchemeNetworkServer.enhancePaymentRequirements(baseRequirements, {
            ...supportedKind,
            x402Version: __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$VE37GDG2$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["x402Version"]
   ...
   */ findMatchingRequirements(availableRequirements, paymentPayload) {
        switch(paymentPayload.x402Version){
            case 2:
                return availableRequirements.find((paymentRequirements)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["deepEqual"])(paymentRequirements, paymentPayload.accepted));
            case 1:
   ...
   */ getFacilitatorClient(x402Version2, network, scheme) {
        ...
        if (!versionMap) return void 0;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$3IUBYRYG$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["findByNetworkAndScheme"])(versionMap, scheme, network);
    }
};
;
 //# sourceMappingURL=index.mjs.map
}),
"[project]/typescript/packages/mechanisms/evm/dist/esm/exact/server/index.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/typescript/packages/mechanisms/svm/dist/esm/chunk-ZAD54HVP.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        case SOLANA_DEVNET_CAIP2:
            {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f40$solana$2b$rpc$40$2$2e$3$2e$0_fastestsmallesttextencoderdecoder$40$1$2e$0$2e$22_typescript$40$5$2e$9$2e$2$2f$node_modules$2f40$solana$2f$rpc$2f$dist$2f$index$2e$node$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSolanaRpc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f40$solana$2b$rpc$2d$types$40$2$2e$3$2e$0_fastestsmallesttextencoderdecoder$40$1$2e$0$2e$22_typescript$40$5$2e$9$2e$2$2f$node_modules$2f40$solana$2f$rpc$2d$types$2f$dist$2f$index$2e$node$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["devnet"])(url));
            }
...
"[project]/typescript/packages/mechanisms/svm/dist/esm/exact/server/index.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$mechanisms$2f$svm$2f$dist$2f$esm$2f$chunk$2d$ZAD54HVP$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/typescript/packages/mechanisms/svm/dist/esm/chunk-ZAD54HVP.mjs [middleware] (ecmascript)");
;
// src/exact/server/scheme.ts
var ExactSvmScheme = class {
   ...
   * @returns The parsed asset amount in USDC
   */ defaultMoneyConversion(amount, network) {
        const tokenAmount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$mechanisms$2f$svm$2f$dist$2f$esm$2f$chunk$2d$ZAD54HVP$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["convertToTokenAmount"])(amount.toString(), 6);
        return {
            amount: tokenAmount,
            asset: (0, __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$mechanisms$2f$svm$2f$dist$2f$esm$2f$chunk$2d$ZAD54HVP$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["getUsdcAddress"])(network),
            extra: {}
        };
    }
};
...
"[project]/typescript/packages/extensions/dist/esm/chunk-STXY3Q5R.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f$ajv$40$8$2e$17$2e$1$2f$node_modules$2f$ajv$2f$dist$2f$2020$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/examples/typescript/node_modules/.pnpm/ajv@8.17.1/node_modules/ajv/dist/2020.js [middleware] (ecmascript)");
var BAZAAR = "bazaar";
...
function validateDiscoveryExtension(extension) {
    try {
        const ajv = new __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f$ajv$40$8$2e$17$2e$1$2f$node_modules$2f$ajv$2f$dist$2f$2020$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"]({
            strict: false,
            allErrors: true
        });
...
"[project]/typescript/packages/extensions/dist/esm/bazaar/index.mjs [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=typescript_packages_cdf490b8._.js.map