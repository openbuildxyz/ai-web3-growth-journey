module.exports = [
"[project]/typescript/packages/http/next/dist/esm/index.js [middleware] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function createHttpServer(routes, server, paywall, syncFacilitatorOnStart = true) {
    const httpServer = new __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$chunk$2d$RCHDDVGC$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__["x402HTTPResourceServer"](server, routes);
    if (paywall) {
...
function handlePaymentError(response) {
    ...
    if (response.isHtml) {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$3_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"](response.body, {
            status: response.status,
            headers
        });
    }
    headers.set("Content-Type", "application/json");
    return new __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$3_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify(response.body || {}), {
        status: response.status,
        headers
    });
}
async function handleSettlement(httpServer, response, paymentPayload, paymentRequirements) {
    ...
    try {
        ...
        if (!result.success) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$examples$2f$typescript$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_$40$babel$2b$core$40$7$2e$28$2e$3_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify({
...
function paymentProxyFromConfig(routes, facilitatorClients, schemes, paywallConfig, paywall, syncFacilitatorOnStart = true) {
    const ResourceServer = new __TURBOPACK__imported__module__$5b$project$5d2f$typescript$2f$packages$2f$core$2f$dist$2f$esm$2f$server$2f$index$2e$mjs__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["x402ResourceServer"](facilitatorClients);
    if (schemes) {
...
//# sourceMappingURL=typescript_packages_http_next_dist_esm_index_6abdb84f.js.map